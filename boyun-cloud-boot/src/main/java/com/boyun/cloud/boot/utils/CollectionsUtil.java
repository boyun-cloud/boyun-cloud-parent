...
/**
 * @className: com.boyun.cloud.boot.untils.CollectionsUtil
 * @projectName: BoyunCloud项目
 * @module: BoyunCloud项目-CollectionsUtil类，主要位于集合操作工具类模块
 * @content: CollectionsUtil-集合操作工具类
 * @author: Powered by Marklin
 * @datetime: 2024-07-29 15:50
 * @version: 1.0.0
 * @copyright: Copyright © 2018-2024 BoyunCloud Systems Incorporated. All rights reserved.
 */
public class CollectionsUtil extends CollectionUtil {
  ...
  public static <T> Predicate<T> distinct(Function<? super T, Object> function) {
    ...
    return index -> sets.add(function.apply(index));
  }
