...
import com.boyun.cloud.boot.constant.Primitives;
import com.boyun.cloud.boot.utils.BeanCopierUtil;
...
/**
 * @className: com.boyun.cloud.boot.pojo.BaseObject
 * @projectName: 封装BoyunCloud项目-BaseObject类
 * @module: BoyunCloud项目-BaseObject类，主要位于BoyunCloud基础Boot工程模块的业务场景
 * @content: BaseObject类，主要用于完成BaseObject基础操作对象的封装和定义.
 * @author: Powered by Marklin
 * @datetime: 2024-06-17 12:43
 * @version: 1.0.0
            ...
            for (Field thisField : thisFields) {
                ...
                if (!Collection.class.isAssignableFrom(thisField.getType())) {
                    ...
                    if (       sourceClass == String.class
                            ...
                            || sourceClass == LocalDateTime.class
                            || sourceClass == LocalDate.class
