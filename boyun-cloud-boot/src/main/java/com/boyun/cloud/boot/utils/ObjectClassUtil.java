...
/**
 * @className: com.boyun.cloud.boot.untils.ObjectClassUtil
 * @projectName: 封装BoyunCloud项目-ObjectClassUtil类
 * @module: BoyunCloud项目-ObjectClassUtil类，主要位于BoyunCloud模块的业务场景
 * @content: ObjectClassUtil类，主要用于完成ObjectClassUtil的封装和定义.
 * @author: Powered by Marklin
 * @datetime: 2024-07-09 19:48
 * @version: 1.0.0
